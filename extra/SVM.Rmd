...
combined_data <- rbind(accuracy_train_data, accuracy_valid_data, accuracy_test_data)
View(combined_data)
```

```{r}
# Plot accuracies for all datasets
ggplot(combined_data, aes(x = Metric, y = Value, fill = Dataset)) +
  ...
  labs(title = "Model Accuracy Across Training, Validation, and Test Sets",
       ...
       y = "Accuracy") +
  theme_minimal() +
  scale_fill_manual(values = c("Train" = "#7C9885", "Validation" = "#D4A5A5", "Test" = "#A5C4D4"))
```
